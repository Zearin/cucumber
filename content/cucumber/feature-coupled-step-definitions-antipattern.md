...
An imaginary resume application could have the following Feature and step files:
...
\## Rename `step.rb` files to a domain-related name (rather than feature- or scenario-related name).
